<div class="menu-profile-admin mb-4">
    ...
    <a href="{{ route('logok.index',$token) }}"
       class="<?= $mitra_active == 'logok' ? 'btn my-1 btn-warning px-4 shadow-warning' : 'btn my-1 btn-light px-4 border-warning'?>">Logo Kemitraan</a>
</div>
