...
<div class="col-md-8 offset-md-2 pt-4">
    ...
    <form action="{{ route('berita.update', ['token' => $token, 'berita' => $news->id_pemberitahuan]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="news_title" id="news_title" class="form-control @error('news_title') is-invalid @enderror" placeholder="Besok ada sesuatu..." aria-describedby="nameId" value="{{ $news->nama }}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="news_location" id="news_location" class="form-control @error('news_location') is-invalid @enderror" aria-describedby="waktuId" value="{{ $news->location }}">
        ...
        <div class="form-group">
            <input type="hidden" name="news_viewer" id="news_viewer" class="form-control" aria-describedby="viewId" value="{{ $news->viewer }}">
            <small id="viewId" class="text-muted d-none"></small>
        </div>
        <div class="form-group">
            <label for="news_content">Deskripsi Berita</label>
            <textarea name="news_content" id="texteditor" cols="30" rows="10" class="form-control @error('news_content') is-invalid @enderror" placeholder="Isi dari news.." aria-describedby="textId">{{ $news->text }}</textarea>
