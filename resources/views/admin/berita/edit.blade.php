...
<div class="col-md-8 offset-md-2 pt-4">
    ...
    <form action="{{ route('berita.update', ['token' => $token, 'berita' => $news->id_news]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="news_title" id="news_title" class="form-control" placeholder="Besok ada sesuatu..." aria-describedby="nameId" value="{{ $news->news_title }}">
        ...
        <div class="form-group">
            ...
            <input type="location" name="news_location" id="news_location" class="form-control" aria-describedby="waktuId" value="{{ $news->news_location }}">
        ...
        <div class="form-group">
            ...
            <textarea name="news_content" id="texteditor" cols="30" rows="10" class="form-control" placeholder="Isi dari news.." aria-describedby="textId">{{ $news->news_content }}</textarea>
