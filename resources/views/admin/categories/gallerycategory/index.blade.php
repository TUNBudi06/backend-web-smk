        ...
        <div class="row">
            ...
            <div class="col-md-4 offset-md-1 mt-4 p-2">
                <div class="w-100 rad bg-white position-relative shadow py-3 px-4">
                    ...
                    <form action="{{ route('gallery.category.update', ['token' => $token, 'gallery_category' => $category->id_category]) }}" method="post">
                        @method('patch')
                        @csrf
                        ...
                        <div class="text-right w-100 position-absolute" style="right: 10px;">
                            <a href="{{ route('gallery.category.create', ['token' => $token]) }}" class="btn btn-white px-4 rounded-pill border-warning">Tambah</a>
                ...
                <div class="w-100 table-parent bg-white">
                    <div class="row p-4">
                        ...
                        <div class="col-md-4 text-right">
                            <a href="{{ route('gallery.index', ['token' => $token]) }}" class="btn-print btn btn-white border-warning px-3 rounded-pill"><i class="fas fa-newspaper"></i> gallery</a>
                        </div>
                    </div>
                    <table class="table">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('gallery.category.edit', ['gallery_category' => $data->id_category, 'token' => $token]) }}" class="btn btn-success p-2"><i class="fas fa-pen-alt"></i></a>
                                    <form action="{{ route('gallery.category.destroy', ['gallery_category' => $data->id_category, 'token' => $token]) }}" method="post" class="d-inline" onclick="return confirm('Pengumuman akan dihapus ?')">
                                        @csrf
                                        @method('delete')
                    ...
                    <div class="row px-3">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            {{ $gallerys->count() }} dari {{ $gallerys->count() }} data</p>
                            <a href="#"
