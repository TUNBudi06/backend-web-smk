        ...
        <div class="row">
            ...
            <div class="col-md-4 offset-md-1 mt-4 p-2">
                <div class="w-100 rad bg-white position-relative shadow py-3 px-4">
                    ...
                    <form action="{{ route('pengumuman.category.update', ['token' => $token, 'pengumuman_category' => $category->id_pemberitahuan_category]) }}" method="post">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="text-right w-100 position-absolute" style="right: 10px;">
                            <a href="{{ route('pengumuman.category.create', ['token' => $token]) }}" class="btn btn-white px-4 rounded-pill border-warning">Kembali</a>
                ...
                <div class="w-100 table-parent bg-white">
                    <div class="row p-4">
                        <div class="col-md-8">
                            ...
                            <p class="montserrat" style="font-size: .85rem;">Daftar Kategori Pengumuman SMKN 1 Purwosari
                            </p>
                        </div>
                        <div class="col-md-4 text-right">
                            <a href="{{ route('pengumuman.index', ['token' => $token]) }}" class="btn-print btn btn-white border-warning px-3 rounded-pill"><i class="fas fa-newspaper"></i> Pengumuman</a>
                        </div>
                    </div>
                    <table class="table">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('pengumuman.category.edit', ['pengumuman_category' => $data->id_pemberitahuan_category, 'token' => $token]) }}" class="btn btn-success p-2"><i class="fas fa-pen-alt"></i></a>
                                    <form action="{{ route('pengumuman.category.destroy', ['pengumuman_category' => $data->id_pemberitahuan_category, 'token' => $token]) }}" method="post" class="d-inline" onclick="return confirm('Pengumuman akan dihapus ?')">
                                        @csrf
                                        @method('delete')
                    ...
                    <div class="row px-3">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            {{ $pengumuman->count() }} dari {{ $pengumuman->count() }} data</p>
                            <a href="#"
