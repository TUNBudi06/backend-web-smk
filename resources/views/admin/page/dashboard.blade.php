...
@section('container')
    <div class="row mt-5">
        <div class="col-md-11 offset-md-1">
            <div class="row gy-4">
                <div class="col-md-4 mb-2"onclick="window.location.href='{{ route('pengumuman.index', ['token' => $token]) }}';">
                ...
                <div class="col-md-4 mb-2" onclick="window.location.href='{{ route('event.index', ['token' => $token]) }}';" >
                    <div class="count-card rounded px-4 py-3">
                ...
                <div class="col-md-4 mb-2" onclick="window.location.href='{{ route('berita.index', ['token' => $token]) }}';">
                    <div class="count-card rounded px-4 py-3">
                ...
                <div class="col-md-4 mb-2" onclick="window.location.href='{{ route('artikel.index', ['token' => $token]) }}';">
                    <div class="count-card rounded px-4 py-3">
