        ...
        <div class="row pb-3">
            <div class="col-md-11 offset-md-1">
                <div class="row gy-4">
                    ...
                    <div class="col-md-6 mb-1" onclick="window.location.href='{{ route('jurusan.index', ['token' => $token]) }}';">
                        <div class="count-card rounded p-3">
                    ...
                    <div class="col-md-6 mb-1" onclick="window.location.href='{{ route('extra.index', ['token' => $token]) }}';">
                        <div class="count-card rounded p-3">
                    ...
                    <div class="col-md-6 mb-1" onclick="window.location.href='{{ route('fasilitas.index', ['token' => $token]) }}';">
                        <div class="count-card rounded p-3">
                    ...
                    <div class="col-md-6 mb-1" onclick="window.location.href='{{ route('pd.index', ['token' => $token]) }}';">
                        <div class="count-card rounded p-3">
                    ...
                    <div class="col-md-6 mb-1" onclick="window.location.href='{{ route('ptk.index', ['token' => $token]) }}';">
                        <div class="count-card rounded p-3">
                    ...
                    <div class="col-md-6 mb-1" onclick="window.location.href='{{ route('gallery.index', ['token' => $token]) }}';">
                        <div class="count-card rounded p-3">
