    ...
    <div class="row mt-5">
        <div class="col-md-11 offset-md-1">
            <div class="row gy-4">
                ...
                <div class="col-md-6 mb-2" onclick="window.location.href='{{ route('event.index', ['token' => $token]) }}';" >
                    <div class="count-card rounded px-4 py-3">
                ...
                <div class="col-md-6 mb-2" onclick="window.location.href='{{ route('artikel.index', ['token' => $token]) }}';">
                    <div class="count-card rounded px-4 py-3">
                ...
                <div class="col-md-6 mb-2"
                    ...
                    <div class="{{session()->get('user')->role == 1 ? 'count-card' : ' count-comment bg-gray'}} rounded px-4 py-3">
                        <p class="poppins mb-2"><i class="fas mr-2 fa-school"></i>Extrakurikuler</p>
