            ...
            <div class="profile-body bg-white px-3">
                <div class="position-relative" style="top: -50px;">
                    ...
                    <div class="name-profile ml-2 position-absolute d-inline-block" style="top: 20px;">
                        <h4 class="text-white poppins">Admin</h4>
                        <p class="text-dark montserrat" style="font-size: .8rem;"><i class="fas fa-envelope text-warning"></i> admin@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6 py-3">
        <form action="" method="">
            ...
            <div class="form-group">
                ...
                <input required type="text" value="admin" name="nama" id="nama" class="form-control border-0" placeholder="Pak Luthfi" aria-describedby="namaId">
                <small id="namaId" class="text-muted d-none">Nama</small>
            </div>
            <div class="form-group">
                <label for="email">Email administrator</label>
                <input required type="email" value="adminemail" name="email" id="email" class="form-control border-0" placeholder="Pak Luthfi" aria-describedby="emailId">
                <small id="emailId" class="text-muted d-none">Nama</small>
            </div>
            <div class="form-group">
                <label for="password">Password administrator yang lama</label>
                <input required type="password" name="password" id="password" class="form-control border-0" aria-describedby="passwordId">
                <small id="passwordId" class="text-muted d-none">Nama</small>
            </div>
            <div class="form-group">
                <label for="passwordnew">Password administrator yang baru</label>
                <input required type="passwordnew" name="passwordnew" id="passwordnew" class="form-control border-0" aria-describedby="passwordnewId">
        ...
        <form action="" method="">
            <div class="form-group">
                ...
                <input required type="token" name="token" id="token" class="form-control border-0" aria-describedby="generate">
