        ...
        <div class="row">
            ...
            <div class="col-md-4 offset-md-1 mt-4 p-2">
                <div class="w-100 rad bg-white position-relative shadow py-3 px-4">
                    ...
                    <form action="{{ route('alert.update', ['token' => $token, 'alert' => session('alerts')->id_alert]) }}" method="post">
                        @method('put')
                        @csrf
                        <div class="form-group">
                            <label for="nama" class="mt-3 mb-2">Nama Alert</label>
                            <input type="text" required value="{{ session('alerts')->alert_title }}" name="alert_title" id="alert_title" class="form-control" placeholder="Isi Alert">
                        </div>
                        <div class="form-group">
                            <label for="tipe" class="my-2">Button URL</label>
                            <input type="text" required value="{{ session('alerts')->alert_url }}" name="alert_url" id="alert_url" class="form-control" placeholder="https://...">
                        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('alert.edit', ['alert' => $data->id_alert, 'token' => $token]) }}" class="btn btn-success p-2"><i class="fas fa-pen-alt"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
