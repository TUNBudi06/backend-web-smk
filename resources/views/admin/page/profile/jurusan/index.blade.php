                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset(file_exists(public_path('img/jurusan/logo/' . $data->jurusan_logo)) ? 'img/jurusan/logo/' . $data->jurusan_logo : 'img/no_image.png') }}" width="100px" class="rounded" alt=""></td>
