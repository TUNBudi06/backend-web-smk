...
<div class="col-md-8 offset-md-2 mt-5">
    ...
    <form action="{{ route('elearning.update', ['token' => $token, 'elearning' => $elearning->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <div class="form-group">
            <label for="title">Judul E-Learning</label>
            <input type="text" name="title" id="title" class="form-control" placeholder="Microsoft Office..." aria-describedby="nameId" value="{{ $elearning->title }}">
            @error('title')
        ...
        <div class="form-group">
            ...
            <textarea name="desc" id="desc" class="form-control" placeholder="Jurnal By" aria-describedby="jurnalById" rows="5">{{ $elearning->desc }}</textarea>
            @error('desc')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="row mb-4 mt-2">
            <div class="col-md-4">
                ...
                <input type="text" name="btn_label" id="btn_label" class="form-control" placeholder="Microsoft Office..." aria-describedby="nameId" value="{{ $elearning->btn_label }}">
                @error('btn_label')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="btn_url" id="btn_url" class="form-control" placeholder="Microsoft Office..." aria-describedby="nameId" value="{{ $elearning->btn_url }}">
                @error('btn_url')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="body_desc" id="body_desc" class="form-control" placeholder="Jurnal By" aria-describedby="jurnalById" rows="5">{{ $elearning->body_desc }}</textarea>
            @error('body_desc')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="body_url" id="body_url" class="form-control" placeholder="Konten URL..." aria-describedby="nameId" value="{{ $elearning->body_url }}">
            @error('body_url')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
