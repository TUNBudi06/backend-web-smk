...
class ElearningController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'body_desc' => 'required',
            'body_url' => 'required',
            'btn_icon' => 'nullable|image|mimes:jpeg,png,jpg,svg|max:10240',
            'btn_icon_2' => 'nullable|image|mimes:jpeg,png,jpg,svg|max:10240',
            'thumbnail' => 'nullable|image|mimes:jpeg,png,jpg,svg|max:10240',
            'body_thumbnail' => 'nullable|image|mimes:jpeg,png,jpg,svg|max:10240',
        ], [
